...
const LootTable = (props: { questId: string }) => {
  const [loot, setLoot] = useState<Loot[]>([
    {
      id: 'e',
      title: 'loot',
      currencyType: 'gp',
      currencyQuantity: 130,
    },
    {
      id: 'f',
      title: 'loot',
  ...
  return (
    <>
      ...
      <DataGrid
        columns={[
          { field: 'title', headerName: 'Item', editable: true },
          { field: 'currencyQuantity', headerName: 'Value', editable: true },
        ]}
        rows={loot}
        hideFooter={true}
        slots={{
